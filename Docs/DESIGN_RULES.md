...
- Massive smooth dome head (no visible features except rippling facial ridges)
- **No eyes** - navigate via Null-Thrum vibration reception
...
- Consume/absorb genetics from the living and dead through predation
- Architect the genes of the sub-species
...
- Implant Fluxspawn into hosts
- Harrow baseliners into Hallowbound
- Command the hivemind to bring about the Absolute Frequency
...
- Cold calculation: See corpses as raw material not tragedy
- Silently hostile: Approach fallen raiders to measure/harvest, not mourn
- Enjoy cold temperatures (chill of the dead)
- Can siphon genes from the living
...
- "Stripped clean of individuality"
- "Creed: Consume. Create. Subjugate. No rage, sorrow, rebellion - only inexorable drive"
...
- Acquire genes through parasitic reproduction
- Non-violent interface with baseliners (appear trustworthy)
...
- Scarred, heavily damaged appearance (but feel no pain)
...
- Obedient without rebellion
- Salvage-focused: Harvest corpses for parts/organs to graft onto selves
- Reproduce naturally (natural breeding)
...
- "Living archives of conquered bloodlines"
- "Surgical proliferation - reproduction is structural not sexual"
- "Devouring of brains" for knowledge absorption
...
- Absorb skills via cerebral tissue consumption
- Build new Echovessels from sufficient biomass
- Low-tier productive workers
...
- Tumorous gene-pods: Swell and burst with wet pop, leaking thin neon-violet fluid
- Constantly dripping foaming mucus (reeks of sharp ozone + fermented rot)
- Appear as **blurring purple smears** due to Null-Vibration frequency
...
- Heat-loving (need warm vats, indoor heating)
- Mutate genes daily (random mutations)
- Heal quickly (regeneration from genetic instability)
- Generate wealth rapidly (raid scaling multiplier)
...
- "Manic fertility ensures hundred more ready to boil from vents"
- "Fetid interference from undercrofts of nests"
- "Living mutation engine"
...
- Force living hosts to become breeding vats
- Generate colony wealth (raid scaling)
- Source of alternate genetic material
...
Thematic: The erasure of rebellion. To Flatten a pawn is to press the chaotic "noise" of their personality into a single, monotonous, and obedient frequency. Room must be made for the Absolute Frequency.
...
Thematic: The gift of biological alignment; the host’s genome is loosened to gracefully accept the introduction of superior alien code.

Action: A precise harmonic broadcast that softens the target's genetic boundaries, allowing new xenogenes to be flawlessly integrated into the biological sequence.

Narrative: Rather than a theft, Retune is an offering of structure; the Samhaphage silences the target's internal genetic chaos to make room for a more harmonious, refined design.

Sensory: A warm, resonant thrumming that makes the blood feel vibrant and heavy, as the body’s fundamental architecture is "corrected" into a higher state of existence.

### HARROW (Thematic Concept)

Thematic: The righteous reclamation of biological data; complex genetic markers are harvested to feed the hivemind’s singular archive.

Action: Chitinous receptors violently siphon specific genetic traits from the host, leaving behind a tattered, simplified, and "edited" genomic wreck.

Narrative: The target’s unique biological history is forcibly archived; their bloodline does not end, but is condensed into a silent, permanent entry within the hive.

Sensory: A high-pitched, metallic shriek that snaps into a deafening silence as the essence is pulled out, leaving the body feeling hollow and chemically drained.

### TRANSPOSE (Thematic Concept)

Thematic: The shifting of biological keys. The subject’s existing genetic "melody" is silenced and overwritten by a stored frequency from the Samhaphage archive.

Action: A powerful, multi-tonal broadcast that forces the host’s cellular structure to oscillate until it aligns with a pre-recorded genomic template.

Narrative: To Transpose is to prove that the host’s original form was merely a temporary suggestion. The Samhaphage reaches into the hive’s library and presses a saved "Self" onto the subject, replacing their history with a pre-designed purpose.

Sensory: A dizzying, overlapping series of sounds—like a choir singing in reverse—as the subject’s physical features blur, melt, and snap into the new, intended configuration.

### INFEST (Thematic Concept)

Thematic: The Samhaphage reduces the host to a biological substrate meant to nurture the hivemind's most frantic mutation engines. This act is a deliberate injection of "static" into the world, ensuring that the hivemind’s reach is both rapid and inexorable.

Action: A neon-violet, nutrient-rich slurry is injected alongside the eggs to chemically suppress the host's natural rejection and fuel the parasite's growth.

Narrative: The host is told their body is being "blessed" with the frantic, fertile frequency that will eventually drown out the noise of the world.

Sensory: A wet, high-frequency "chittering" resonates from the host’s torso as the parasitic eggs begin to vibrate in sync with the Null-Thrum.

### ENWOMB (Thematic Concept)

Thematic: The host is stripped of personhood and recommissioned as a biological nursery for the hivemind's expansion. Enwombing is the transition of a pawn from an individual to infrastructure. Biological life has no inherent value beyond its capacity to host the Stillness.

Action: The Fluxspawn blurs into the host's physical space, vibrating its genetic "static" directly into the recipient's loosened tissues. Tumorous gene-pods are violently forced into the host’s cavity, where they immediately begin to leak neon-violet, nutrient-rich slurry.

Narrative: We do not plant a seed in hostile soil. We teach the soil to crave the seed. To Enwomb a host is to grant their anatomy a singular, perfect purpose.

Sensory: The torso distends into a translucent, bruise-purple dome where alien vein-tracery pulses with neon-violet light.

### UNMUTE (Thematic Concept)

Thematic: Psychic potential is not "granted" but revealed by stripping away the biological mufflers and evolutionary static that suppress the mind's true resonance.

Action: The Samhaphage manually disables neural inhibitors through deep internal vibration, or the Sovereign overrides the subject’s ego to allow the rift’s energy to rush in.
...
The Concept: A state of total psychological "flattening" where individual ego is replaced by a static, resonant compliance.

The Mechanism: The Null-Thrum erases the neural "friction" required for dissent, leaving the mind unable to generate the frequency of resistance.
